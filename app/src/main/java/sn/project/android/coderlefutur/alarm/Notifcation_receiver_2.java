...
public class Notifcation_receiver_2 extends BroadcastReceiver {
    @Override
    ...
    NotificationManager notificationManager = (NotificationManager) context.getSystemService (Context.NOTIFICATION_SERVICE);
        ...
        if ( s_HTML.equals ( "HTML" ) ){
            ...
            PendingIntent pendingIntent = PendingIntent.getActivity (context,1,repeating,PendingIntent.FLAG_UPDATE_CURRENT);
            Intent intentParametre = new Intent (context,Acceuil_Agenda.class);
            PendingIntent pendingParametre = PendingIntent.getActivity (context,1,intentParametre,PendingIntent.FLAG_UPDATE_CURRENT);
        ...
        if ( s_JavaScript.equals ( "JavaScript" ) ){
            ...
            PendingIntent pendingIntent = PendingIntent.getActivity (context,2,repeating,PendingIntent.FLAG_UPDATE_CURRENT);
            Intent intentParametre = new Intent (context,Acceuil_Agenda.class);
            PendingIntent pendingParametre = PendingIntent.getActivity (context,2,intentParametre,PendingIntent.FLAG_UPDATE_CURRENT);
