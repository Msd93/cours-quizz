...
public class Notifcation_receiver_4 extends BroadcastReceiver {
    @Override
    ...
    NotificationManager notificationManager = (NotificationManager) context.getSystemService (Context.NOTIFICATION_SERVICE);
        ...
        if ( s_HTML.equals ( "HTML" ) ){
            ...
            PendingIntent pendingIntent = PendingIntent.getActivity (context,4,repeating,PendingIntent.FLAG_UPDATE_CURRENT);
            Intent intentParametre = new Intent (context,Acceuil_Agenda.class);
            PendingIntent pendingParametre = PendingIntent.getActivity (context,4,intentParametre,PendingIntent.FLAG_UPDATE_CURRENT);
            ...
            notificationManager.notify (41,builder.build ());
        }
