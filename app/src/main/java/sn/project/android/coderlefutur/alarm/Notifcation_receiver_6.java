...
public class Notifcation_receiver_6 extends BroadcastReceiver {
    @Override
    ...
    NotificationManager notificationManager = (NotificationManager) context.getSystemService (Context.NOTIFICATION_SERVICE);
     ...
     String s_PHP = extra.getString("PHP");
        ...
        if ( s_HTML.equals ( "HTML" ) ){
            ...
            PendingIntent pendingIntent = PendingIntent.getActivity (context,6,repeating,PendingIntent.FLAG_UPDATE_CURRENT);
            Intent intentParametre = new Intent (context,Acceuil_Agenda.class);
            PendingIntent pendingParametre = PendingIntent.getActivity (context,6,intentParametre,PendingIntent.FLAG_UPDATE_CURRENT);
            ...
            notificationManager.notify (61,builder.build ());
        }
        if ( s_JavaScript.equals ( "JavaScript" ) ){
            ...
            notificationManager.notify (62,builder.build ());
        }
        if ( s_JAVA.equals ( "JAVA" ) ){
            ...
            notificationManager.notify (63,builder.build ());
        }
        if ( s_PHP.equals ( "PHP" ) ){
