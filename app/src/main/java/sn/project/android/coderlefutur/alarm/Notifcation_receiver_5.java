...
public class Notifcation_receiver_5 extends BroadcastReceiver {
    @Override
    ...
    NotificationManager notificationManager = (NotificationManager) context.getSystemService (Context.NOTIFICATION_SERVICE);
        ...
        if ( s_HTML.equals ( "HTML" ) ){
            ...
            PendingIntent pendingIntent = PendingIntent.getActivity (context,5,repeating,PendingIntent.FLAG_UPDATE_CURRENT);
            Intent intentParametre = new Intent (context,Acceuil_Agenda.class);
            PendingIntent pendingParametre = PendingIntent.getActivity (context,5,intentParametre,PendingIntent.FLAG_UPDATE_CURRENT);
        ...
        if ( s_JAVA.equals ( "JAVA" ) ){
            ...
            notificationManager.notify (53,builder.build ());
        }
        if ( s_PHP.equals ( "PHP" ) ){
