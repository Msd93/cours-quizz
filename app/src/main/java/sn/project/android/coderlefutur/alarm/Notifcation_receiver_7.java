...
public class Notifcation_receiver_7 extends BroadcastReceiver {
    @Override
    ...
    NotificationManager notificationManager = (NotificationManager) context.getSystemService (Context.NOTIFICATION_SERVICE);
        ...
        if ( s_HTML.equals ( "HTML" ) ){
            ...
            PendingIntent pendingIntent = PendingIntent.getActivity (context,7,repeating,PendingIntent.FLAG_UPDATE_CURRENT);
            Intent intentParametre = new Intent (context,Acceuil_Agenda.class);
            PendingIntent pendingParametre = PendingIntent.getActivity (context,7,intentParametre,PendingIntent.FLAG_UPDATE_CURRENT);
            ...
            notificationManager.notify (71,builder.build ());
        }
        if ( s_JavaScript.equals ( "JavaScript" ) ){
            ...
            notificationManager.notify (72,builder.build ());
        }
        ...
        if ( s_C.equals ( "C" ) ){
            ...
            notificationManager.notify (75,builder.build ());
        }
        if ( s_Cpp.equals ( "Cpp" ) ){
            ...
            notificationManager.notify (76,builder.build ());
        }
